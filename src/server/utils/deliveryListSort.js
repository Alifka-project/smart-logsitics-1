 ...
 * @param {Array<{ address?: string | null, phone?: string | null, createdAt?: unknown, created_at?: unknown, CreatedAt?: unknown }>} deliveries
 * @returns {void} Sorts in place.
 */
function sortDeliveriesIncompleteLast(deliveries) {
  if (!Array.isArray(deliveries) || deliveries.length === 0) return;
  deliveries.sort((a, b) => {
    const hasAddressAndPhone = (d) =>
...
module.exports = { sortDeliveriesIncompleteLast };
