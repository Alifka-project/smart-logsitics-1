 ...
 * @param {string} options.confirmationLink - The full /confirm-delivery/{token} URL
 * @param {string} [options.deliveryAddress] - Delivery address (optional)
...
async function sendConfirmationEmail({ toEmail, customerName, confirmationLink, deliveryAddress }) {
  ...
  const addressLine = deliveryAddress ? `<p style="color:#555;font-size:14px;">Delivery address: <strong>${deliveryAddress}</strong></p>` : '';
