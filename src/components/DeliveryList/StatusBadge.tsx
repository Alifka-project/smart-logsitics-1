...
const STATUS_CONFIG: Record<string, StatusConfig> = {
  ...
  'pickup-confirmed':               { dot: 'bg-teal-500',    bg: 'bg-teal-50 dark:bg-teal-900/20',       text: 'text-teal-700 dark:text-teal-300',      label: 'Pickup Confirmed'     },
  'pickup_confirmed':               { dot: 'bg-teal-500',    bg: 'bg-teal-50 dark:bg-teal-900/20',       text: 'text-teal-700 dark:text-teal-300',      label: 'Pickup Confirmed'     },
