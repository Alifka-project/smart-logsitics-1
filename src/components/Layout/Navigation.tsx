...
import { LayoutDashboard, Settings, FileText, Users, Database } from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  { icon: FileText, label: 'Reports', path: '/admin/reports', exact: false },
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                />
                <span
                  className={`hidden sm:inline transition-all duration-300 relative z-10 ${
                    isActive
