...
export default function ForgotPasswordPage() {
  ...
  if (success) {
    return (
      <div className="min-h-screen flex items-center justify-center px-4 py-8 light" style={bgStyle}>
        <div className="w-full max-w-6xl bg-white rounded-3xl border-4 border-white shadow-2xl overflow-hidden flex flex-col lg:flex-row">
          <div className="w-full lg:w-1/2 relative overflow-hidden p-4 lg:p-6 flex flex-col justify-between rounded-t-3xl lg:rounded-l-3xl lg:rounded-tr-none" style={leftPanelStyle} />
      ...
      <div className="w-full max-w-6xl bg-white rounded-3xl border-4 border-white shadow-2xl overflow-hidden flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-1/2 bg-white p-8 lg:p-12 flex flex-col justify-center rounded-b-3xl lg:rounded-r-3xl lg:rounded-bl-none">
          <div className="max-w-md mx-auto w-full">
            <h2 className="text-3xl lg:text-4xl font-bold mb-2" style={{ color: '#000000' }}>
              FORGOT PASSWORD?
            </h2>
            ...
            <div className="mt-6 text-center">
              <Link to="/login" className="text-sm font-medium hover:underline" style={{ color: '#000000' }}>
                Back to Login
              </Link>
            </div>
          </div>
