...
export default function LogisticsTeamPortal() {
  ...
  const [liveMapsDateMode, setLiveMapsDateMode] = useState<'today' | 'tomorrow' | 'all'>('all');
                ...
                <div className="flex flex-col gap-2 min-w-0 min-h-0 w-full">
                  ...
                  <div className="flex-shrink-0 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg overflow-visible">
                      ...
                      <div className="relative">
                        <button
                          ...
                          className={`inline-flex items-center gap-1 px-2 py-1.5 text-xs rounded-md border transition-colors ${
                            (filterPriority || filterDelayed || trackingDriverFilter !== 'all' || liveMapsDateMode !== 'all')
                    ...
                    {(() => {
                      ...
                      if (liveMapsDateMode !== 'all') {
                        activeFilters.push({ label: liveMapsDateMode === 'today' ? 'Today only' : 'Tomorrow only', clear: () => setLiveMapsDateMode('all') });
                      }
