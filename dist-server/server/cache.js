...
exports.getOrFetch = exports.stats = exports.clear = exports.invalidatePrefix = exports.deleteEntry = exports.del = exports.set = exports.get = void 0;
class ServerCache {
    constructor() {
        this.store = new Map();
...
exports.set = cache.set.bind(cache);
exports.del = cache.delete.bind(cache);
exports.deleteEntry = cache.delete.bind(cache);
exports.invalidatePrefix = cache.invalidatePrefix.bind(cache);
exports.clear = cache.clear.bind(cache);
exports.stats = cache.stats.bind(cache);
exports.getOrFetch = cache.getOrFetch.bind(cache);
