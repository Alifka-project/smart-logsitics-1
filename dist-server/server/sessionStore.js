...
exports.destroyUserSessions = destroyUserSessions;
...
function makeId() {
    return crypto_1.default.randomBytes(32).toString('hex'); // Increased from 24 to 32 for better security
}
function makeClientKey() {
    return crypto_1.default.randomBytes(32).toString('hex'); // Increased from 18 to 32
}
